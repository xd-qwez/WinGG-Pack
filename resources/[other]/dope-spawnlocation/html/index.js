$(document).ready(function(){
    ...
    $(document).on("click", ".fas", function(e){
        var th = $(this)
        if (current != null) {
            $("#loc"+current).css("color", "rgb(255, 255, 255)");
            $("#loc"+current).css("font-size", "x-large");
            $("#label"+current).fadeOut(400);
        }
       $("#loc"+th.data("id")).css("color", "rgb(110, 50, 160)");
    ...
    $(document).on("click", "#lastpos", function(e){
        if (current != null) {
            $("#loc"+current).css("color", "rgb(110, 50, 160)");
            $("#loc"+current).css("font-size", "x-large");
            $("#label"+current).fadeOut(400);
        }
    });
    ...
    $(document).on("click", ".play", function(e){
        ...
        if (pos != null) {
            ...
            $.post('http://dope-spawnlocation/spawn', JSON.stringify({coords: pos}));
        }
    });
