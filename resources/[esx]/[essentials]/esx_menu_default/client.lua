	...
	CreateThread(function()
		while true do
			...
			if OpenedMenuCount > 0 then
				...
				if IsDisabledControlJustReleased(0, Keys['ENTER']) and GetLastInputMethod(2) and (GetGameTimer() - GUI.Time) > 150 then
				...
				if (IsDisabledControlJustReleased(0, Keys[',']) or IsDisabledControlJustReleased(0, Keys['NENTER'])) and GetLastInputMethod(2) and (GetGameTimer() - GUI.Time) > 150 then
					SendNUIMessage({
						action  = 'controlPressed',
						control = 'NENTER'
					})
				...
				if IsDisabledControlJustReleased(0, Keys['BACKSPACE']) or IsDisabledControlJustReleased(0, 91) and GetLastInputMethod(2) and (GetGameTimer() - GUI.Time) > 150 then
