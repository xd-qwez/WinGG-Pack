Locales['pl'] = {
  ...
  ['invalid_firstname_format'] = 'Nieprawidłowy format (imię): Spróbuj ponownie.',
  ['invalid_lastname_format'] = 'Nieprawidłowy format (imię): Spróbuj ponownie.',
  ['invalid_dob_format'] = 'Nieprawidłowy format (data urodzenia): Spróbuj ponownie.',
  ['invalid_sex_format'] = 'Nieprawidłowy format (płeć): Spróbuj ponownie.',
  ['invalid_height_format'] = 'Nieprawidłowy format (wysokość): Spróbuj ponownie.'
}