...
Config.Weapons = {
	...
	{name = 'WEAPON_MACHETE', label = _U('weapon_machete'), item = 'machete', components = {}},
	...
	{name = 'WEAPON_CERAMICPISTOL', label = _U('weapon_ceramicpistol'), item = "ceramicpistol", tints = Config.DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_rounds'), hash = `AMMO_PISTOL`}},
	{
	...
	{name = 'WEAPON_DOUBLEACTION', label = _U('weapon_doubleaction'), item = 'doubleaction', tints = Config.DefaultWeaponTints, components = {}, ammo = {label = _U('ammo_rounds'), hash = `AMMO_PISTOL`}},
	...
	{name = 'WEAPON_STUNGUN', label = _U('weapon_stungun'), item = "stungun", tints = Config.DefaultWeaponTints, components = {}},
