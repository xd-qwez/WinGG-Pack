local Components = {
	...
	{label = _U('tshirt_1'),				name = 'tshirt_1',			value = 0,		min = 0,	zoomOffset = 0.75,		camOffset = 0.15, restrictMale = {197, 198}, restrictFemale = {267, 271}},
	{label = _U('tshirt_2'),				name = 'tshirt_2',			value = 0,		min = 0,	zoomOffset = 0.75,		camOffset = 0.15,	textureof	= 'tshirt_1'},
	{label = _U('torso_1'),					name = 'torso_1',			value = 0,		min = 0,	zoomOffset = 0.75,		camOffset = 0.15, restrictMale = {458, 461, 499}, restrictFemale = {507, 524}},
	...
	{label = _U('mask_1'),					name = 'mask_1',			value = 0,		min = 0,	zoomOffset = 0.6,		camOffset = 0.65, restrictMale = {211, 212, 213}, restrictFemale = {204, 205}},
...
function ApplySkin(skin, clothes)
	...
	SetPedHeadOverlay			(playerPed, 3,		Character['age_1'],				((Character['age_2'] or 0.0) / 10) + 0.0)			-- Age + opacity
	SetPedHeadOverlay			(playerPed, 1,		Character['beard_1'],			((Character['beard_2'] or 0.0) / 10) + 0.0) -- Beard + opacity
	SetPedEyeColor				(playerPed,			Character['eye_color'], 0, 1)												-- Eyes color
	SetPedHeadOverlay			(playerPed, 2,		Character['eyebrows_1'],		((Character['eyebrows_2'] or 0.0) / 10) + 0.0)		-- Eyebrows + opacity
	SetPedHeadOverlay			(playerPed, 0,		Character['blemishes_1'],		((Character['blemishes_2'] or 0.0) / 10) + 0.0)		-- Blemishes + opacity
	SetPedHeadOverlay			(playerPed, 4,		Character['makeup_1'],			((Character['makeup_2'] or 0.0) / 10) + 0.0)			-- Makeup + opacity
	SetPedHeadOverlay			(playerPed, 8,		Character['lipstick_1'],		((Character['lipstick_2'] or 0.0) / 10) + 0.0)		-- Lipstick + opacity
	...
	SetPedHeadOverlay			(playerPed, 5,		Character['blush_1'],			((Character['blush_2'] or 0.0) / 10) + 0.0)			-- Blush + opacity
	SetPedHeadOverlayColor		(playerPed, 5, 2,	Character['blush_3'])														-- Blush Color
	SetPedHeadOverlay			(playerPed, 6,		Character['complexion_1'],		((Character['complexion_2'] or 0.0) / 10) + 0.0)		-- Complexion + opacity
	SetPedHeadOverlay			(playerPed, 7,		Character['sun_1'],				((Character['sun_2'] or 0.0) / 10) + 0.0)			-- Sun Damage + opacity
	SetPedHeadOverlay			(playerPed, 9,		Character['moles_1'],			((Character['moles_2'] or 0.0) / 10) + 0.0)			-- Moles/Freckles + opacity
	SetPedHeadOverlay			(playerPed, 10,		Character['chest_1'],			((Character['chest_2'] or 0.0) / 10) + 0.0)			-- Chest Hair + opacity
	SetPedHeadOverlayColor		(playerPed, 10, 1,	Character['chest_3'])														-- Torso Color
	SetPedHeadOverlay			(playerPed, 11,		Character['bodyb_1'],			((Character['bodyb_2'] or 0.0) / 10) + 0.0)			-- Body Blemishes + opacity
...
RegisterNetEvent('skinchanger:restrictAllow')
AddEventHandler('skinchanger:restrictAllow', function()
