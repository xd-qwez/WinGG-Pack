...
BANK = {
    ...
    Transfer = function(xTarget, xPlayer, amount, key)
        ...
        exports['core']:SendLogToDiscord('https://discord.com/api/webhooks/1064759294102360137/TuBqHpiWKdsSZgxz5s1yXQ5pbIdhaes4SIEcbw7xnfxhowZxsv8Ar-rgDjFF1CChjPmE', 'Przelew pieniędzy', 'ID: '..xPlayer.source..'\nNick: '..xPlayer.name..'\nLicencja: '..xPlayer.identifier..'\nPrzelewa kwotę: '..amount..'$\n\n**dla gracza:**\n\nID: '..xTarget.source..'\nNick: '..xTarget.name..'\nLicencja: '..xTarget.identifier, 3447003)
