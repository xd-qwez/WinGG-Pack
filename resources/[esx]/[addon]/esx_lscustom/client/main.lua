            ...
            if v.modType then
                ...
                if v.modType == 14 then -- HORNS
                    for j = 0, 51, 1 do
                        ...
                        if currentMods and j == currentMods.modHorns then
                ...
                elseif v.modType == 'plateIndex' then -- PLATES
                    for j = 0, 4, 1 do
                        local _label = ''
                        if currentMods and j == currentMods.plateIndex then
                ...
                elseif v.modType == 22 then -- NEON
                    local _label = ''
                    if currentMods and currentMods.modXenon then
                ...
                elseif v.modType == 23 then -- WHEELS RIM & TYPE
                    ...
                    for j = 0, modCount, 1 do
                        ...
                        if modName then
                            local _label = ''
                            if currentMods and j == currentMods.modFrontWheels then
                ...
                elseif v.modType == 11 or v.modType == 12 or v.modType == 13 or v.modType == 15 or v.modType == 16 then
                    ...
                    for j = 0, modCount, 1 do
                        local _label = ''
                        if currentMods and j == currentMods[k] then
                            _label =
                ...
                elseif v.modType == 17 then -- TURBO
                    local _label = ''
                    if currentMods and currentMods[k] then
...
CreateThread(function()
    for k,v in pairs(Config.Zones) do 
        CM.RegisterPlace(vec3(v.Pos.x,v.Pos.y,v.Pos.z-0.9), {size=vec3(5.0,5.0,1.0)} , "otworzyć menu ulepszania aut",
        function()
            local vehicle = GetVehiclePedIsIn(PlayerPedId(), false)
