	...
	CreateThread(function()
		while true do
			...
			if cfg.preventVehicleFlip then
				...
				if (roll > 100.0 or roll < -100.0) and GetEntitySpeed(vehicle) < 2 then
...
CreateThread(function()
	while true do
		...
		if isPedDrivingAVehicle() then
			...
			if healthEngineCurrent <= cfg.engineSafeGuard+1 and not cfg.limpMode then
				if IsVehicleEngineOn(vehicle) then
					TriggerEvent("ESX:Notify", "error", 3000, "Zbyt duże uszkodzenia pojazdu, dalsza jazda niemożliwa")
				end
